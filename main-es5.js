...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcApp_modulesAtelierAtelierComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AtelierComponent_textarea_58_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AtelierComponent_table_60_tr_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AtelierComponent_table_60_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AtelierComponent_div_63_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AtelierComponent_div_64_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function AtelierComponent_div_64_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AtelierComponent_div_65_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function AtelierComponent_div_65_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AtelierComponent_div_66_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function AtelierComponent_div_66_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AtelierComponent_div_67_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
        ...
        value: function readFileToarray(value) {
          ...
          for (var i = 0; i < splitted.length; i++) {
            ...
            if (data != undefined && data[0] != undefined && data[0].length > 2) {
              this.tabPlayerInfos.push(new _shared_models_player_info_model__WEBPACK_IMPORTED_MODULE_1__["PlayerInfo"]().build(this.convertString(data[0]), this.convertString(this.stringToLowerCase(this.stringReplaceSpecial(data[1]))), this.convertString(this.stringToUpperCase(this.stringReplaceSpecial(data[2]))), this.convertString(data[3]), this.convertString(data[4]), this.convertString(data[5]), this.convertString(data[6]), this.convertString(data[7]), this.convertString(data[8]), this.convertString(data[9])));
            }
          }
        }
      }, {
    ...
    AtelierComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AtelierComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AtelierComponent_Template_button_click_40_listener() {
  ...
  function srcApp_sharedModelsPlayerInfoModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PlayerInfo = /*#__PURE__*/function () {
      ...
      _createClass(PlayerInfo, [{
        key: "build",
        value: function build(ffgNumber, prenom, nom, circuit, categorie, nbrRoundThisYear, email, phoneNumber, comment, date) {
          return new PlayerInfo().setFfgNumber(ffgNumber).setPrenon(prenom).setNom(nom).setCircuit(circuit).setCategorie(categorie).setNbrRoundThisYear(nbrRoundThisYear).setEmail(email).setPhoneNumber(phoneNumber).setComment(comment).setDate(date);
        }
      }, {
        key: "setDate",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/xpia057/sources/perso/dataGolf22/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
